...
class GWOFeatureSelector:
    ...
    def __init__(
        ...
        Args:
            ...
            groups: Optional group labels for GroupKFold CV (e.g., patient IDs)
        """
    ...
    def _fitness_function(self, solution: np.ndarray) -> float:
        ...
        try:
            # Use GroupKFold if groups are provided, otherwise standard CV
...
def select_features_gwo(
    ...
    # Convert groups to numpy array if provided
